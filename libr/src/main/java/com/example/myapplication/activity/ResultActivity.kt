    ...
    private fun initViews() {
        ...
        binding.share.setOnClickListener {
            if (binding.textview1!!.text.toString().equals("No Text", ignoreCase = true)) {
                ...
                this@ResultActivity.startActivity(Intent.createChooser(intent2, "Share"))
            }
        }
        ...
        binding.copy.setOnClickListener {
            ...
            if (Random().nextInt(5) + 0 != 0) {
                (this@ResultActivity.getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager).setPrimaryClip(
